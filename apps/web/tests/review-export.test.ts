...
it(
  "exports a paginated PDF with embedded Unicode text using the production builder",
  async () => {
  ...
  // Embedding a full Unicode font across 90+ lines is CPU-bound and can run
  // past the default 5s timeout under a fully parallel test-suite run.
  { timeout: 15000 },
);
